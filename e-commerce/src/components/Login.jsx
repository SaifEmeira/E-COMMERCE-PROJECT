    ...
    <div>
      ...
      <form className="max-w-md mx-auto" onSubmit={formik.handleSubmit}>
        ...
        <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
          {loading ? <i className='fas fa-spin fa-spinner text-white fa-1x'></i> : "Login"}
        </button>
      </form>

      <p className='text-center my-3'>Dont have acoount <Link to={'/register'} className='text-green-700 font-bold'>REGISTER</Link></p>

      <p className='text-center my-3'> <Link to={'/forget'} className='text-green-700 font-bold'>FORGET PASSWORD</Link></p>
